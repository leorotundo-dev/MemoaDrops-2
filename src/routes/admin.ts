    ...
    try {
      ...
      return {
        users: {
          ...
          active_dau: activeDAU?.active_dau || 0,
          active_mau: activeMAU?.active_mau || 0
        },
        finance: {
          mrr,
        ...
        content: {
          ...
          public_decks: publicDecks?.public_decks || 0,
          public_cards: publicCards?.public_cards || 0
        },
        system: {
          api_status: apiStatus,
          db_status: dbStatus,
          active_jobs: activeJobs?.active_jobs || 0,
          failed_jobs: failedJobs?.failed_jobs || 0
        }
      };
    } catch (error: any) {
